...
showTeamPosition(5); // O time que está em 5º lugar é o Flamengo.
...
function convertToHex(x) {
  switch (x) {
    ...
    case 'white':
      ...
      break;
    case 'green':
      console.log("O hexadecimal para a cor green é #41D500.")
      break;
    case 'blue':
      console.log("O hexadecimal para a cor blue é #2DA9FF.")
      break;
    default:
